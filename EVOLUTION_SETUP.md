...
| Secret | Value | Source |
|--------|-------|--------|
| `TOURHAB_URL` | `https://vedarai.ru` | Production URL |
...
curl https://vedarai.ru/api/cron/evolution-loop/status | jq '.last_evolution_run'

# Recent initiatives
curl https://vedarai.ru/api/cron/evolution-loop/status | jq '.recent_initiatives'
```
...
2. Check board-meeting endpoint: `https://vedarai.ru/api/cron/board-meeting`
...
4. Check prod endpoint: `https://vedarai.ru/api/cron/evolution-loop/status`
