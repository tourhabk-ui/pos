 ...
 *
 * В этой схеме «одинаковый id» живёт в двух типах сразу:
 *
 *   kamchatka_routes.id  — UUID
 *   places.id            — TEXT
 *   route_waypoints      — пережила объявление 167 (`CREATE TABLE IF NOT
 *                          EXISTS` поверх уже существовавшей таблицы), и
 *                          объявленные там UUID до прода не доехали
 *
