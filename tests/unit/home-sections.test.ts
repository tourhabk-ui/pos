...
describe('двери в каталог схлопнуты', () => {
  ...
  it('заголовков на главной немного — иначе это снова лендинг из дверей', () => {
    // 6, а не 5 (итерация north-star 31.07): «Сводка по вашему району» —
    // заголовок режима активной поездки. Это не дверь в каталог (плитки ведут
    // в навигатор/радар/карту, не в выдачу), и гость его не видит — секция
    // рендерится только при подтверждённой поездке. Дальнейший рост — снова
    // разговор, а не правка числа.
