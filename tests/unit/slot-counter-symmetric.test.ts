...
describe('ответ об отмене не выдумывает решение о возврате', () => {
  ...
  it('сумма возврата — по условиям тура и реальная, не догадка (решение 24.09)', () => {
    // 11.09 «пока 100%» заменено 24.09 правилом «как у оператора»: сумму
    // считает recordRefundDue от оплаты в HELD (tour_payments), не константа
    // и не с клиента. Оплаты не было — refund null, а НЕ ноль: ноль читался
