...
const PLACES = [
  ...
  // Имя после миграции 927 — до неё стояло «Вулкан Крашенникова», без «ин».
  { arkId: 'a12', name: 'Вулкан Крашенинникова' },
];
...
describe('живой случай: имена KVERT против имён каталога', () => {
  ...
  const CASES: Array<[string, string]> = [
    ...
    // Порядок правок: сперва миграция 927 чинит имя места, потом алиас. В
    // обратном порядке алиас бесполезен — прогон 02.09 после деплоя показал
    // KRASHENINNIKOV в «нет в алиасах» при уже исправленном месте.
    ['KRASHENINNIKOV', 'Вулкан Крашенинникова'],
  ];
