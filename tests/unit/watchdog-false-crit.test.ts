...
describe('пустой push-канал — не отказ доставки', () => {
  ...
  it('ноль подписчиков — не критично: чинится воронкой, а не доставкой', () => {
    expect(CODE).toMatch(/vapidSet && subs === 0[\s\S]{0,400}critical: false/);
  });
  ...
  it('текст пустого канала не называет это отказом доставки', () => {
