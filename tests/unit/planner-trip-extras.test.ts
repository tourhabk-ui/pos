 ...
 *   зона      — миграция 1031 (CHECK из четырёх зон движка, без угадывания),
...
describe('миграция 1031: зона планера у объекта', () => {
  const m = read('migrations/1031_accommodation_planner_zone.sql');
