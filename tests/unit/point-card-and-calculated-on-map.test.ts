 ...
 *     Передача в чужой навигатор снята 13.09 (владелец: «кнопка навигация до
 *     сих пор открывает сторонние сервисы») — полевой экран ведёт сам;
...
describe('карточка точки — как в навигаторе', () => {
  ...
  it('карточка: число — кнопка формата, копирование, «Проложить сюда»; чужих навигаторов нет', () => {
    ...
    expect(CARD).not.toContain('<NavigateTo');
