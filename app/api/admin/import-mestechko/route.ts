...
const INCLUDED_DEFAULT = ['Услуги гида', 'Экскурсионная программа', 'Обед', 'Сбор за посещение заповедника'];
const WHAT_TO_BRING    = ['Солнечные очки', 'Рюкзак', 'Фотоаппарат', 'Удобная обувь', 'Ветровка'];
const INCLUDED_HELI    = ['Трансфер в аэропорт', 'Вертолётный перелёт', 'Услуги гида', 'Сборы заповедника', 'Обед'];
const INCLUDED_SNOW    = ['Трансфер из отеля', 'Необходимое снаряжение', 'Питание', 'Страховка'];
const INCLUDED_FISH    = ['Проживание на базе', '3-разовое питание + ланч', 'Аренда моторной лодки', 'Гид-рыбак', 'Разрешение на вылов', 'Баня', 'Трансфер до базы', 'Страховка'];
...
const TOURS = [
  ...
  },
  {
    ...
    included: ['Трансфер (по запросу)', 'Вертолётный перелёт', 'Сборы заповедника', 'Услуги гида', 'Катание на лодке', 'Обед/бранч'],
    what_to_bring: WHAT_TO_BRING,
    photos: [
  ...
  // ── СНЕГОХОДНЫЕ ──────────────────────────────────────────────────────────
  {
    ...
    what_to_bring: ['Тёплая одежда', 'Термобельё', 'Шлем (выдаётся)', 'Перчатки', 'Очки'],
    photos: [
  ...
  // ── РЫБАЛКА ──────────────────────────────────────────────────────────────
  {
    ...
    what_to_bring: ['Рыболовные снасти', 'Вейдерсы', 'Тёплая одежда', 'Непромокаемая куртка', 'Средство от комаров'],
    photos: [
      `${BASE}/2024/03/r1.jpg`,
      `${BASE}/2024/03/r2.jpg`,
      `${BASE}/2024/03/r3.jpg`,
  ...
  // ── ХЕЛИ-СКИ ─────────────────────────────────────────────────────────────
  {
    ...
    included: ['Вертолёт (Ми-8)', 'Гид с сертификатом первой помощи', 'Проживание', 'Лавинный инструктаж', 'Опционально: аренда снаряжения'],
    what_to_bring: ['Горные лыжи или сноуборд', 'Лавинный рюкзак', 'Бипер', 'Зонд', 'Лопата', 'Шлем', 'Очки', 'Термобельё'],
    photos: [
      `${BASE}/2025/01/img22.jpg`,
      `${BASE}/2025/01/img28.jpg`,
      `${BASE}/2025/01/img37.jpg`,
