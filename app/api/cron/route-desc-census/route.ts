...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    return NextResponse.json({
      ...
      // v4 — судья понимает стороны и доставку (проба 128): «12 км в одну
      // сторону» сравнивается и с удвоением, «в обе стороны» — и с половиной;
      // предложение о доставке к старту («из Ключей на внедорожнике: 60 км
