 ...
 *   4. поля из TRANSFER_FIELDS (паспорт, МЧС, опасности, описание…)
 *      доносятся по правилу «заполнить только пустое» (04.09); конфликт —
 *      у обоих заполнено по-разному — остаётся человеку, warning на каждый;
