 ...
 * v3 — проба 101 (слияние близнеца Пиначево): запуск, который сам пушит
 * в main, обязан поднимать маркер — иначе POST уйдёт в старый контейнер.
 */
export async function GET(request: NextRequest) {
  ...
  return NextResponse.json({ success: true, probe: 'family_merge_v3', live_batch_max: LIVE_BATCH_MAX });
}
