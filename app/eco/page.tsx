...
const PRINCIPLES: Principle[] = [
  ...
  },
  {
    ...
    points: [
      ...
      'Если планируете разводить костёр — выбирайте только разрешённые места, вне периода противопожарного режима, на расчищенной от горючего площадке и не при сильном ветре.',
      'Тушите по «правилу трёх П»: полил, перевернул, потрогал. Костёр потушен, только когда разворошённых углей можно спокойно коснуться рукой.',
    ],
  },
  {
  ...
  },
  {
    ...
    points: [
      ...
      'Не прикармливайте диких животных — ни из рук, ни отходами и остатками еды на стоянке. Прикормленный зверь теряет страх перед человеком и навык добывать пищу сам.',
      'С медведем это работает как приговор: однажды связав запах человека с едой, он начнёт выходить к людям и требовать её — такого зверя, как правило, ждёт отстрел. Угощая, вы убиваете его.',
      ...
      <main className="pb-20">
        ...
        <section className="max-w-3xl mx-auto px-4 mt-10">
          <p className="text-xs text-[var(--text-muted)] leading-relaxed border-t border-[var(--border)] pt-5">
            ...
            Правила обращения с огнём и дикими животными сверены с памятками
            Природоохранного Фонда защитников природы и проекта «Земля медведя».
          </p>
        </section>
      </main>
    </div>
