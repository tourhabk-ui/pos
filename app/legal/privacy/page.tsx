      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="prose prose-invert max-w-none space-y-6 text-[var(--text-secondary)]">
          ...
          <section>
            ...
            <p>
              Уведомления о заявках, содержащие имя и контактный телефон Пользователя, направляются
              сотрудникам Оператора и Партнёрам через российский мессенджер <strong>MAX</strong>. Мессенджер Telegram используется Оператором
              только для служебных сообщений, не содержащих персональных данных: в него передаётся номер
              заявки, а имя и телефон остаются в MAX и в личном кабинете.
            </p>
            <p>
          ...
          <section>
            ...
            <p>
              ...
              vedarai.ru/legal/privacy. При существенных изменениях Пользователи уведомляются по электронной
