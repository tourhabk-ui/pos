      ...
      <main className="flex-1">
        ...
        <div className="max-w-7xl mx-auto px-4 mt-16 mb-12">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <div className="group relative p-6 rounded-lg bg-[var(--bg-card)] border border-[var(--border)] text-center transition-all duration-300 hover:shadow-xl hover:shadow-[var(--accent)]/5 hover:-translate-y-1 hover:border-[var(--accent)]/40">
              <div className="w-14 h-14 mx-auto mb-4 rounded-lg bg-gradient-to-br from-[var(--accent)]/20 to-[var(--accent)]/5 flex items-center justify-center transition-all duration-300 group-hover:scale-110 group-hover:from-[var(--accent)]/30 group-hover:to-[var(--accent)]/10">
