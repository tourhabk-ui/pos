          ...
          <Accordion items={[
            {
              ...
              a: 'Ничего дополнительного от вас не требуется — OCTO API уже настроен для всех туров на платформе. Администратор Ведара создаёт API-ключ и подаёт заявку на партнёрство с OTA. После одобрения ваши туры появляются автоматически.',
            },
            {
              q: 'Изменится ли цена для иностранных туристов?',
              a: 'Базовая цена та же, что вы указываете в системе. OTA могут добавлять собственную наценку. Вы получаете выплату по вашей цене минус комиссия Ведара.',
            },
            {
