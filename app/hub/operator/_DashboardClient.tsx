...
import { BarChart3, Calendar, Users, TrendingUp, Plus, FileText, DollarSign } from 'lucide-react';
    ...
    <div className="p-6 max-w-6xl mx-auto space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <Link href="/hub/operator/bookings" className="ds-card p-6 hover:bg-[var(--bg-hover)] transition">
          <h3 className="ds-h2 text-base mb-2 flex items-center gap-2"><FileText className="w-4 h-4" /> Букировки</h3>
