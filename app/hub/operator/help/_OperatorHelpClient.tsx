...
export default function OperatorHelpClient() {
  const sections: SectionCard[] = [
    ...
    },
    {
      ...
      tips: [
        'Telegram: Профиль компании → «Подключить Telegram» — бот откроется по личной ссылке (/start link_…, действует 30 минут)',
          ...
          <div className="flex gap-3">
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-2">
                ...
                >
                  <ExternalLink size={11} /> Telegram @kuzmichai_bot
                </a>
              </div>
              <p className="text-xs text-[var(--text-muted)] mt-1">В MAX мессенджере найдите Кузьмич по нику kuzmichai_bot</p>
            </div>
          </div>
