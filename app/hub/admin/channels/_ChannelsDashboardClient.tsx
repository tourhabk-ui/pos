...
const CHANNELS = [
  {
    ...
    feedUrl: 'https://vedarai.ru/api/channels/avito/feed',
    priority: 1,
  },
  {
    id: 'yandex',
    ...
    feedUrl: 'https://vedarai.ru/api/channels/yandex/feed',
    priority: 2,
  },
  {
    id: 'tripster',
        ...
        <div className="bg-[var(--bg-hover)] rounded-lg p-4 flex items-center justify-between gap-3">
          <div>
            ...
            <code className="text-sm text-[var(--text-primary)] font-mono">
              https://vedarai.ru/api/channels/avito/feed
            </code>
          </div>
          <CopyButton text="https://vedarai.ru/api/channels/avito/feed" />
        </div>
      ...
      <div className="ds-card p-6 mb-6 border-l-4 border-[var(--warning)]">
        ...
        <div className="bg-[var(--bg-hover)] rounded-lg p-4 flex items-center justify-between gap-3">
          <div>
            ...
            <code className="text-sm text-[var(--text-primary)] font-mono">
              https://vedarai.ru/api/channels/yandex/feed
            </code>
          </div>
          <CopyButton text="https://vedarai.ru/api/channels/yandex/feed" />
        </div>
        <div className="mt-3 flex items-center gap-2 text-xs text-[var(--text-muted)]">
          ...
          {[
            {
              ...
              body: 'Авито → Мой Авито → Управление объявлениями → Автозагрузка → Добавить. Вставить URL: https://vedarai.ru/api/channels/avito/feed',
            },
            {
