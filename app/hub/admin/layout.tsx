...
const SIDEBAR_ITEMS = [
  ...
  { href: '/hub/admin/content/routes', label: 'Модерация маршрутов', icon: Route },
  { href: '/hub/admin/content/reviews', label: 'Отзывы', icon: MessageSquareText },
  { href: '/hub/admin/moderation', label: 'Модерация отзывов', icon: ShieldCheck },
  ...
  { href: '/hub/admin/routes-analysis', label: 'Анализ маршрутов', icon: LineChart },
  ...
  { href: '/hub/admin/telegram',     label: 'Telegram-бот',      icon: MessageCircle },
  ...
  { href: '/hub/admin/photos', label: 'Загрузка фото', icon: ImageIcon },
  { href: '/hub/admin/videos', label: 'Видео', icon: Video },
  ...
  { href: '/hub/admin/enrich-places', label: 'Обогащение мест', icon: Sprout },
