...
const CACHE_NAME = 'kamchatour-v19'; // bumped: офлайн-навигация чинится только у того, кто получит новый SW — RSC-запрос больше не гасится разметкой /offline (полевой тест 30.07: бесконечный скелетон на всех офлайн-ссылках)
