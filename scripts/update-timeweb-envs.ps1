...
$TG_TOKEN  = Get-EnvValue "TELEGRAM_BOT_TOKEN" "REDACTED_TG_TOKEN_2"
...
$envs = @(
    ...
    @{ name = "NEXTAUTH_URL";               value = "https://vedarai.ru" },
    @{ name = "NEXT_PUBLIC_APP_URL";        value = "https://vedarai.ru" },
    @{ name = "NEXT_PUBLIC_API_BASE_URL";   value = "https://vedarai.ru" },
