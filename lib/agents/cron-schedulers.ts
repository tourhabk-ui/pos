...
export const MANUAL_ENDPOINTS: Record<string, SchedulerDeclaration> = {
  ...
  'images-oversize':           { kind: 'manual', writes: true,  note: 'тяжёлые снимки: перепись по весу и происхождению (GET) и удаление (POST). Порог обязателен и без умолчания, причина обязательна, сухой прогон по умолчанию. Снимок у места ровно один — удаление оставляет градиент навсегда' },
