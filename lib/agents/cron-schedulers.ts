...
export const MANUAL_ENDPOINTS: Record<string, SchedulerDeclaration> = {
  ...
  'images-to-s3':              { kind: 'manual', writes: true,  note: 'перенести снимки мест из base64-байтов в базе в S3: заливка, ПРОВЕРКА чтением, и только потом обнуление image_data. Сухой прогон по умолчанию, партия <=10, причина обязательна' },
  ...
  // 'images-recompress' и 'images-generated' объявлений здесь не несут: их
