...
// Экспортируется для повторного использования (напр. геокодер плейсхолдер-мест
// исключает такие имена — геокодить «Восхождение на…» бессмысленно).
export const NON_PLACE_RE =
