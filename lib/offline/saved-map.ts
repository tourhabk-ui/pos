 ...
 * в поле. Теперь заявление проверяется делом — `sampleUrls` хранит пробу
 * адресов, а судит о ней `lib/offline/tiles-present.ts`, общий на регионы,
 * полевые пакеты и карту маршрута.
 *
