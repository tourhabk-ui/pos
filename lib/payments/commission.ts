 ...
 * было. ЧИСЛО ПОЛУЧЕНО (перепись `rate_drift` в
 * `GET /api/cron/commission-dry-run`, прогон 11.09): таких партнёров на
 * проде **ноль**, у всех ставка равна 10. Значит это задел на будущее, а не
 * текущая потеря, и срочности у правки нет. Записано именно так, чтобы
