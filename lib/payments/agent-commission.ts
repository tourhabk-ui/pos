 ...
 *
 *   ставка        — partners.agent_commission_rate записи агента (1023). Её
 ...
 *                   (agent_payout_items, 1024): смена ставки не переписывает
...
/** Верхняя граница ставки — та же, что в CHECK миграции 1023. */
