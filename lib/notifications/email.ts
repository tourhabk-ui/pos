        ...
        <div class="container">
          ...
          <div class="content">
            ...
            <div class="footer">
              ...
              <!--
                Телефона здесь нет намеренно. До 09.09 стояло
                «+7 (XXX) XXX-XX-XX» — плейсхолдер, уезжавший в настоящее
                письмо настоящему туристу: человек, которому понадобилось
                позвонить по броне трансфера, получал номер, по которому
                нельзя дозвониться. Выдумать сюда номер нельзя (§4.0), а
