 ...
 *
 * Контракт общий с пакетом «деньги агента» (сигнатура и тексты те же);
 */
...
/** Тот же текст под именем, которым его зовёт пакет «деньги агента». */
export const AGENT_NOT_APPROVED_ERROR = AGENT_NOT_APPROVED_MESSAGE;
