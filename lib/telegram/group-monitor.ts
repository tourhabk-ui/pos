 ...
 * — Ключевые советы по маршрутам → kamchatka_routes (база знаний)
      ...
      try {
        await pool.query(
          `INSERT INTO kamchatka_routes
             (dedupe_key, title, description, category, source_name, source_url, metadata, is_visible, created_at, updated_at)
