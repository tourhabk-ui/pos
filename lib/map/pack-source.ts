 ...
 */
export const OVERVIEW_BUILT = false;
...
export const BUILT_GRID_CELLS: readonly GridCellId[] = [
  ...
  // Командорского направления. Здесь только те, что уже зелёные и залиты;
  // 54n155e, 54n156e, 54n161e, 54n162e ещё строились на момент правки и
  // войдут отдельной строкой, когда закончат. Обещание ставится по факту
  // заливки, а не по факту запуска.
  'cell-54n157e',
  'cell-54n158e',
  'cell-54n159e',
  'cell-54n160e',
