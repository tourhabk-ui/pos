...
export const FISH_TYPES = {
  chavycha: { name: 'Чавыча', season: ['06', '07'] },
  nerka: { name: 'Нерка', season: ['06', '07', '08'] },
  kizhuch: { name: 'Кижуч', season: ['08', '09', '10', '11'] },
  mikizha: { name: 'Микижа (радужная форель)', season: ['01', '02', '03', '04', '05', '06', '07', '08', '09', '10', '11', '12'] },
  harius: { name: 'Хариус', season: ['01', '02', '03', '04', '05', '06', '07', '08', '09', '10', '11', '12'] },
  kunzha: { name: 'Кунжа', season: ['01', '02', '03', '04', '05', '06', '07', '08', '09', '10', '11', '12'] },
  golets: { name: 'Голец', season: ['01', '02', '03', '04', '05', '06', '07', '08', '09', '10', '11', '12'] },
  goletsKamenets: { name: 'Голец-Каменец', season: ['01', '02', '03', '04', '05', '06', '07', '08', '09', '10', '11', '12'] },
};
