 ...
 *
 * Реестр берётся из стандарта линии, а не заводится свой: 17.08 перепись
 * показала, что два списка одного и того же уже разошлись — `road_graph_astar`
 * здесь синтетика, а в line-standard он был неизвестен и судился по плотности
 * точек. Одно правило в двух местах — это два правила.
 */
