 ...
 *         Передача в чужой навигатор отсюда убрана 13.09 — см. ниже;
  ...
  return (
    <div className="fx-glass-dense rounded-2xl px-4 pt-3 pb-3 text-white" role="dialog" aria-label={title}>
      ...
      {/* Ряд марок чужих навигаторов (Organic Maps / Яндекс / 2ГИС) стоял
          ...
          открывает сторонние сервисы». Из всех мест это было самое странное:
          полевой экран ВЕДЁТ человека сам — компас, азимут на точку, главная
          цифра расстояния, — и предлагать под этим уйти в чужую программу
          значило звать прочь с собственного прибора. «Проложить сюда» выше
          считает путь своим графом и остаётся. */}
    </div>
  );
}
