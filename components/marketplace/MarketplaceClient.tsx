      ...
      <div className="relative h-[320px] sm:h-[380px] lg:h-[420px]">
        ...
        <div className="relative h-full flex flex-col justify-end p-6 sm:p-10 lg:p-12 max-w-2xl">
          <div className="flex items-center gap-2 mb-3">
            ...
            <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-[var(--bg-hover)] text-white text-xs font-medium">
          ...
          <div className="flex flex-wrap gap-3">
            ...
            <a
              href="#tours"
              className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl bg-[var(--bg-hover)] hover:bg-[var(--bg-hover)] text-[var(--text-primary)] text-sm font-medium transition-all duration-200 border border-[var(--border)]"
            >
              Смотреть все туры
