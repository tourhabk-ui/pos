...
// Медальная палитра уровней (бронза/серебро/золото/платина) — доменные цвета
// «металлов», а не тема: не должны меняться со сменой light/dark. Поэтому hex,
// не CSS-токены — как градиенты типов локаций в PlaceCard (аудит 2026-07-09).
const LEVELS = [
