    ...
    <section className="py-24 bg-[var(--bg-primary)]">
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 min-h-[800px]">
          {/* Large Card */}
          <div className="md:col-span-2 md:row-span-2 relative group overflow-hidden rounded-lg bg-[var(--bg-card)]">
            <div className="absolute inset-0 bg-[var(--bg-primary)]/30 group-hover:bg-[var(--bg-primary)]/50 transition-colors duration-500 z-10" />
            <Image 
            ...
            <div className="relative z-20 p-10 h-full flex flex-col justify-end">
              ...
              <Link href={CATEGORIES[0].href} className="w-14 h-14 rounded-full border border-[var(--border)] flex items-center justify-center text-[var(--text-primary)] group-hover:bg-[var(--accent)] group-hover:border-[var(--accent)] group-hover:text-white transition-all">
          ...
          <div className="md:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-6">
            {CATEGORIES.slice(1, 3).map((cat) => (
              <div key={cat.title} className="relative group overflow-hidden rounded-lg min-h-[350px] bg-[var(--bg-card)]">
                ...
                <div className="relative z-20 p-8 h-full flex flex-col justify-end">
                  ...
                  <Link href={cat.href} className="text-[var(--text-primary)] text-[10px] font-bold uppercase tracking-[0.2em] flex items-center gap-2 group-hover:text-[var(--accent)] transition-colors">
          ...
          {/* Medium Card */}
          <div className="md:col-span-2 relative group overflow-hidden rounded-lg min-h-[350px] bg-[var(--bg-card)]">
            <div className="absolute inset-0 bg-[var(--bg-primary)]/30 group-hover:bg-[var(--bg-primary)]/50 transition-colors duration-500 z-10" />
            <Image 
            ...
            <div className="relative z-20 p-10 h-full flex flex-col justify-end">
              ...
              <Link href={CATEGORIES[3].href} className="text-[var(--text-primary)] text-[10px] font-bold uppercase tracking-[0.2em] flex items-center gap-2 group-hover:text-[var(--accent)] transition-colors">
